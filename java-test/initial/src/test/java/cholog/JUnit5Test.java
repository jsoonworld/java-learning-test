...
public class JUnit5Test {
    ...
    class DisplayNameAnnotationTest {
         ...
         */
        @Test
        @DisplayName("DisplayName 애노테이션을 붙여 경고를 제거한다.")
    ...
    class AssertEqualsMethodTest {
        ...
        void assertEquals_메서드로_두_값이_같은지_비교하며_테스트가_실패했을_때_출력되는_메시지를_지정한다() {
            ...
            assertEquals(actual, expected, "두 값이 일치하지 않습니다.");
//            if (expected != actual) {
...
//            final var number = Integer.valueOf(0x80000000);
            assertDoesNotThrow(() -> Integer.valueOf(0x80000000));
        }
    }
    ...
    class ParameterizedAnnotationTest {
        ...
        void ValueSource_애노테이션을_붙여_정수_매개변수를_여러_번_입력받는다(int number) {
...
//        @Test
        ...
        void ValueSource_애노테이션을_활용하여_1부터_5까지의_문자열_값을_Integer로_변경하는_로직이_예외를_발생시키지_않는_지_검증한다(String str) {
...
//            assertDoesNotThrow(() -> Integer.parseInt("5"));
            ...
            assertDoesNotThrow(() -> Integer.parseInt(str));
        }
...
//        @Test
        ...
        void MethodSource_애노테이션을_붙여_정수와_문자열_매개변수를_입력받는다(String str, int expected) {
...
//            assertEquals(Integer.parseInt(str), 2);
//            assertEquals(Integer.parseInt(str), 3);
//            assertEquals(Integer.parseInt(str), 4);

            assertEquals(expected, Integer.parseInt(str));
        }
